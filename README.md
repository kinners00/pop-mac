...
2. [Setup - The basics of getting started with popmac](#setup)
    * [What popmac affects](#what-popmac-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with popmac](#beginning-with-popmac)
